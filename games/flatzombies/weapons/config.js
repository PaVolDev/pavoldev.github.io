...
var sampleParams = [ //Список всех параметров, относящиеся только к оружию в руках
	...
	{ "fieldPath": "weapon.audioShot", "comment": "Звук выстрела", "type": "AudioClip", "value": "" },
	...
	{ "fieldPath": "weapon.magazineMax", "comment": "Кол-во патронов в одном магазине,<br>0 - использовать cartridgesList для патронника chamberSize", "type": "int", "value": 0 },
	...
	{ "fieldPath": "weapon.cartridge.totalStockNum", "comment": "Общее кол-во патронов в запасе у игрока<br>При значении -1 патроны бессконечные", "type": "int", "value": 0 },
	...
	{ "fieldPath": "weapon.shotAudioList", "comment": "Случайный звук выстрела", "type": "AudioClip[]", "value": "" },
	...
	{ "fieldPath": "weapon.reloadScaleTime", "comment": "Скорость перезарядки в секундах. Изменить скорость анимации в соответсвии со скоростью перезарядки", "type": "float", "value": 0 },
	...
	{ "fieldPath": "weapon.WeaponHandPoints.fingerPoint", "comment": "Локальные координаты руки относительно точки вращения Sprite.pivotPoint<br>Локальные координаты правой руки для анимации оружия<br>Локальные координаты красной точки на рендере руки будут преобразованы в координаты в родительском объекте с плечами игрока<br>Координаты в игровых метрах", "type": "Vector3", "value": "(0, 0, 0)", "spritePreview": "images/handpoint.png", "spritePivotPoint": { x: 0.5, y: 0.5 }, "spritePixelPerUnit": 200, "sortingOrder": 1500, "spriteName": "fingerPoint" },
	...
	{ "fieldPath": "weapon.WeaponHandPoints.boltMove", "comment": "Затвор при стрельбе", "type": "WeaponAnimationDetail", "value": "" },
	{ "fieldPath": "weapon.WeaponHandPoints.boltMove.move", "comment": "Движение [0-1]<br>Vector2.Lerp(startPosition, movePosition, move)", "type": "float", "value": 0, "spritePreview": "images/handpoint.png", "spritePivotPoint": { x: 0.5, y: 0.5 }, "spritePixelPerUnit": 200, "sortingOrder": 1500 },
	{ "fieldPath": "weapon.WeaponHandPoints.boltMove.render", "comment": "Рендер детали", "type": "SpriteRenderer", "value": "" },
	{ "fieldPath": "weapon.WeaponHandPoints.boltMove.startPosition", "comment": "Локальные координаты рукоятки", "type": "Vector3", "value": "(0, 0, 0)", "spritePreview": "images/handpoint.png", "spritePivotPoint": { x: 0.5, y: 0.5 }, "spritePixelPerUnit": 200, "sortingOrder": 1500, "spriteName": "boltMove.startPosition" },
	{ "fieldPath": "weapon.WeaponHandPoints.boltMove.movePosition", "comment": "Локальные координаты рукоятки затвора в заднем положении при заряжении патрона", "type": "Vector3", "value": "(0, 0, 0)", "spritePreview": "images/handpoint.png", "spritePivotPoint": { x: 0.5, y: 0.5 }, "spritePixelPerUnit": 200, "sortingOrder": 1500, "spriteName": "boltMove.movePosition" },
	{ "fieldPath": "weapon.WeaponHandPoints.boltMove.sprites", "comment": "Покадровая анимация с помощью спрайтов", "type": "Sprite[]", "value": "" },
	{ "fieldPath": "weapon.WeaponHandPoints.coverMove", "comment": "Рукоять затвора при перезарядке", "type": "WeaponAnimationDetail", "value": "" },
	{ "fieldPath": "weapon.WeaponHandPoints.coverMove.move", "comment": "Движение [0-1]<br>Vector2.Lerp(startPosition, movePosition, move)", "type": "float", "value": 0, "spritePreview": "images/handpoint.png", "spritePivotPoint": { x: 0.5, y: 0.5 }, "spritePixelPerUnit": 200, "sortingOrder": 1500 },
	{ "fieldPath": "weapon.WeaponHandPoints.coverMove.render", "comment": "Рендер детали", "type": "SpriteRenderer", "value": "" },
	{ "fieldPath": "weapon.WeaponHandPoints.coverMove.startPosition", "comment": "Локальные координаты рукоятки", "type": "Vector3", "value": "(0, 0, 0)", "spritePreview": "images/handpoint.png", "spritePivotPoint": { x: 0.5, y: 0.5 }, "spritePixelPerUnit": 200, "sortingOrder": 1500, "spriteName": "coverMove.startPosition" },
	{ "fieldPath": "weapon.WeaponHandPoints.coverMove.movePosition", "comment": "Локальные координаты рукоятки затвора в заднем положении при заряжении патрона", "type": "Vector3", "value": "(0, 0, 0)", "spritePreview": "images/handpoint.png", "spritePivotPoint": { x: 0.5, y: 0.5 }, "spritePixelPerUnit": 200, "sortingOrder": 1500, "spriteName": "coverMove.movePosition" },
