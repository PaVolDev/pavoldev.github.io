...
const ignoreImportFields = ['storeInfo.iconBase64', 'targetVersion', 'version', 'selspriteupd'];
const ignoreExportFields = [
	...
	"player.man.thigh2.Transform.localPosition",
	...
	"player.man.body.weaponParent.arm.forearm.fingers.magazine.Transform.localPosition",
	"player.man.body.weaponParent.arm2.Transform.localPosition",
	...
	"player.man.body.weaponParent.arm2.forearm2.fingers2.magazine2.Transform.localPosition",
	...
	"player.man.body.weaponParent.arm.forearm.fingers.magazine.Transform.localEulerAngles.z",
	"player.man.body.weaponParent.arm2.Transform.localEulerAngles.z",
	...
	"player.man.body.weaponParent.arm2.forearm2.fingers2.magazine2.Transform.localEulerAngles.z",
	...
	"player.man.body.weaponParent.arm2.forearm2.fingers2.magazine2.gameObject.SetActive",
	...
	"player.man.body.weaponParent.arm.forearm.fingers.magazine.SpriteRenderer.sortingOrder",
	"player.man.body.weaponParent.arm2.SpriteRenderer.sortingOrder",
	...
	"player.man.body.weaponParent.arm2.forearm2.fingers2.magazine2.SpriteRenderer.sortingOrder",
	...
	"player.man.body.weaponParent.arm.forearm.fingers.magazine.SpriteRenderer.enabled",
	"player.man.body.weaponParent.arm2.SpriteRenderer.enabled",
	...
	"player.man.body.weaponParent.arm2.forearm2.fingers2.magazine2.SpriteRenderer.enabled",
...
var baseParams = [  //Список параметров, доступные для редактирования у всех оружий
	...
	{ fieldPath: "height", "comment": "Рост персонажа", type: "int", value: 170, min: 160, max: 180 },
...
var sampleParams = [ //Список всех параметров, относящиеся только к оружию в руках
	// { fieldPath: "player.Transform.localPosition", "comment": "Координаты объекта для расположения", type: "Vector3", value: "(1.1, 0.2, 0)" },
	// { fieldPath: "player.Transform.localEulerAngles.z", "comment": "Угол наклона", type: "float", value: 0 },
	// { fieldPath: "player.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	// { fieldPath: "player.SpriteRenderer.sprite.pivotPoint", "comment": "Точка вращения для спрайта", type: "Vector2", value: "(0.5, 0.5)" },
	// { fieldPath: "player.SpriteRenderer.sprite.pixelPerUnit", "comment": "Плотность пикселей", type: "float", value: 100 },
	// { fieldPath: "player.SpriteRenderer.sortingOrder", "comment": "Порядок прорисовки для рендера", type: "int", value: 0 },
	// { fieldPath: "player.SpriteRenderer.enabled", "comment": "Показать/скрыть спрайт при рендеринге", type: "bool", value: true },
	...
	{ fieldPath: "player.man.body.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.forearm.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.forearm.fingers.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.forearm.fingers.render.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.forearm2.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.forearm2.fingers2.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.thigh.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.thigh2.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.thigh.shin.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.thigh2.shin2.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.thigh.shin.foot.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
	...
	{ fieldPath: "player.man.thigh2.shin2.foot2.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", type: "Sprite", suffix: ".SpriteRenderer.sprite", value: "", canChangePosition: false },
