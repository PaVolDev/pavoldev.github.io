...
const ignoreExportFields = [
	"weapon.SpriteRenderer.sprite", "weapon.Transform.localPosition", "weapon.gameObject.SetActive", "weapon.SpriteRenderer.enabled", "weapon.Transform.localEulerAngles.z",
	"weapon.SpriteRenderer.sortingOrder", "weapon.SpriteRenderer.sprite.pixelPerUnit", "weapon.SpriteRenderer.sprite.pivotPoint",
