...
var baseParams = [  //Список параметров, доступные для редактирования у всех оружий
	...
	{ fieldPath: "storeInfo.iconBase64", comment: "Иконка для интерфейса, размер около 200x300<br>Если не указано, то иконка будет сгенерирована автоматически.", type: "Image", value: "" },
	// { fieldPath: "storeInfo.iconBase64.pivotPoint", comment: "Точка вращения для спрайта", type: "Vector2", value: "(0.5, 0.5)" },
	{ fieldPath: "storeInfo.iconBase64.pixelPerUnit", comment: "Масштаб пикселей", type: "float", value: 150 },
	...
	// { fieldPath: "player.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
...
var sampleParams = [ //Список всех параметров, относящиеся только к оружию в руках
	...
	{ showInList: false, fieldPath: "player.man.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.head.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.forearm.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.forearm.fingers.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.forearm.fingers.render.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.forearm2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.forearm2.fingers2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.forearm2.fingers2.girth2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.thigh.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.thigh2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.thigh.shin.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.thigh2.shin2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.thigh.shin.foot.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.thigh2.shin2.foot2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб пикселей", type: "float", value: 100 },
