...
var baseParams = [  //Список параметров, доступные для редактирования у всех оружий
	...
	{ fieldPath: "interface.donateURL", comment: "Ссылка для доната.<br>Рядом с кнопкой 'лайк' появится кнопка для доната", type: "string", value: "https://", placeholder: "https://" },
	...
	// { fieldPath: "player.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
...
var sampleParams = [ //Список всех параметров, относящиеся только к оружию в руках
	...
	{ showInList: false, fieldPath: "player.man.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.forearm.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.forearm.fingers.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm.forearm.fingers.render.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.forearm2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.forearm2.fingers2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
	...
	{ fieldPath: "player.man.body.weaponParent.arm2.forearm2.fingers2.girth2.SpriteRenderer.sprite.pixelPerUnit", "comment": "Масштаб текстуры в игре<br>Pixels Per Unit (PPU)", type: "float", value: 100 },
