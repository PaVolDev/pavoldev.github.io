...
var baseParams = [  //Список параметров, доступные для редактирования у всех оружий
	{ "fieldPath": "weapon.WeaponAnimation", "comment": "Список точек для создания анимации перезарядки оружия", "type": "WeaponHandPoints", "value": "" },
	...
	{ "fieldPath": "weapon.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
...
var sampleParams = [ //Список всех параметров, относящиеся только к оружию в руках
	...
	{ "fieldPath": "weapon.boltRender.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.boltRender.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltRender.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.boltHandle.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.boltHandle.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltHandle.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.sight.SpriteRenderer.sprite", "comment": "Прицел на оружии, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.handgrip.gameObject.SetActive", "comment": "Показать объект на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.handgrip.SpriteRenderer.sprite", "comment": "Рукоятка. Может использоваться для дополнительного отображения пальцев.", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.handgrip.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.handgrip.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.cover.SpriteRenderer.sprite", "comment": "Крышка пулемёта, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.cover.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.cover.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.cover.sight.SpriteRenderer.sprite", "comment": "Прицел на оружии, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.cover.sight.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.cover.sight.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	{ "fieldPath": "weapon.lasersight.Transform.localPosition", "comment": "Координаты объекта для расположения", "type": "Vector3", "value": "(1.1, 0.2, 0)" },
	{ "fieldPath": "weapon.lasersight.Transform.localEulerAngles.z", "comment": "Угол наклона", "type": "float", "value": 0 },
	{ "fieldPath": "weapon.lasersight.SpriteRenderer.sprite", "comment": "Лазер на оружии, PNG-файл", "type": "Sprite", "value": "" },
	{ "fieldPath": "weapon.lasersight.SpriteRenderer.sprite.pivotPoint", "comment": "Точка вращения для спрайта", "type": "Vector2", "value": "(0.5, 0.5)" },
	{ "fieldPath": "weapon.lasersight.SpriteRenderer.sprite.pixelPerUnit", "comment": "Плотность пикселей", "type": "float", "value": 100 },
	{ "fieldPath": "weapon.lasersight.SpriteRenderer.sortingOrder", "comment": "Порядок прорисовки для рендера", "type": "int", "value": 0 },
	{ "fieldPath": "weapon.lasersight.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.boltHandle.boltRender.SpriteRenderer.sprite", "comment": "Рукоятка затвора, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.boltHandle.boltRender.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltHandle.boltRender.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	{ "fieldPath": "weapon.sight.gameObject.SetActive", "comment": "Показать объект на экране", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.gunFlash.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.boltRender.fingers.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltRender.fingers.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.boltBox.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.boltBox.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltBox.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.boltHandle.fingers.gameObject.SetActive", "comment": "Показать объект на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltHandle.fingers.SpriteRenderer.sprite", "comment": "Спрайт/текстура, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.boltHandle.fingers.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltHandle.fingers.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.barrel.SpriteRenderer.sprite", "comment": "Спрайт/текстура ствола, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.barrel.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.barrel.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltRender.handgrip.SpriteRenderer.sprite", "comment": "Рукоятка. Может использоваться для дополнительного отображения пальцев.", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.boltRender.handgrip.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltRender.handgrip.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	{ "fieldPath": "weapon.lasersight.gameObject.SetActive", "comment": "Показать объект на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.laserSight.gameObject.SetActive", "comment": "Показать объект на экране", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.barrel.lasersight.SpriteRenderer.sprite", "comment": "Лазер на оружии, PNG-файл", "type": "Sprite", "value": "" },
	...
	{ "fieldPath": "weapon.barrel.lasersight.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
	{ "fieldPath": "weapon.barrel.lasersight.gameObject.SetActive", "comment": "Показать/скрыть объект", "type": "bool", "value": true },
	{ "fieldPath": "weapon.boltRender.fingers.gameObject.SetActive", "comment": "Показать объект на экране", "type": "bool", "value": true },
	...
	{ "fieldPath": "weapon.cartridge.stopPower", "comment": "Останавливающий эффект [0-1]<br>Зомби сам решает как реагировать на этот параметр", "type": "float", "value": 0 },
	...
	{ "fieldPath": "weapon.damageScale", "comment": "Множитель урона", "type": "float", "value": 0 },
	{ "fieldPath": "weapon.animationClip", "comment": "Анимация оружия", "type": "AnimationClip", "value": "" },
	{ "fieldPath": "weapon.reloadScaleTime", "comment": "Множитель для скорости перезарядки [0.5 - 2]\nСкорость анимации и время для перезарядки", "type": "float", "value": 0 },
	...
	{ "fieldPath": "weapon.magazine.SpriteRenderer.enabled", "comment": "Показать спрайт на экране", "type": "bool", "value": true },
