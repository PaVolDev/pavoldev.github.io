...
var sampleParams = [ //Список всех параметров, относящиеся только к оружию в руках
	...
	//{ "fieldPath": "weapon.shotAnimations[0].animation", "comment": "Анимация выстрела (v2.0.8.beta7)", "type": "string", "value": "fire", options: ["fire", "LabelShotFire"] },
	//{ "fieldPath": "weapon.strikeAnimations[0]", "comment": "Анимация выстрела (v2.0.8.beta7)", "type": "string", "value": "fire", options: ["fire", "LabelShotFire"] },
