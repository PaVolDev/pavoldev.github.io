...
var sampleParams = [ //Список всех параметров, относящиеся только к оружию в руках
	...
	{ "fieldPath": "weapon.damageScale", "comment": "Множитель урона", "type": "float", "value": 0, min: 0.8, max: 1.5 },
	...
	{ "fieldPath": "weapon.cartridge.arrowSample.angleTipSpeed", "comment": "Скорость вращения стрелы внутри тела, когда кончик упирает в землю.\nСкорость за 1 секунду", "type": "float", "value": "0" },
	{ "fieldPath": "weapon.cartridge.arrowSample.damage", "comment": "Урон один раз в процессе горения", "type": "float", "value": "0" },
	{ "fieldPath": "weapon.cartridge.arrowSample.distLivedEntity", "comment": "Радиус/Дистанция для попадания в живых существ.\nЕсли в пределах этого расстояния нет живых, то фиксируем попадние в трупы", "type": "float", "value": "0" },
	...
	{ "fieldPath": "weapon.cartridge.arrowSample.floorWall", "comment": "Радиус/Дистанция для попадания в живых существ.\nЕсли в пределах этого расстояния нет живых, то фиксируем попадние в трупы", "type": "PhysicsMaterial2D", "value": "" },
	...
	{ "fieldPath": "weapon.cartridge.arrowSample.pointTip", "comment": "Кончик стрелы, который будет упираться о землю\nА так же используем для поиска попадания", "type": "Vector2", "value": "(0, 0)" },
	...
	{ "fieldPath": "weapon.cartridge.arrowSample.renderMaterialHit", "comment": "Радиус/Дистанция для попадания в живых существ.\nЕсли в пределах этого расстояния нет живых, то фиксируем попадние в трупы", "type": "Material", "value": "" },
	...
	{ "fieldPath": "weapon.cartridge.arrowSample.render.gameObject.SetActive", "comment": "Показать/скрыть объект вместе с дочерними спрайтами", "type": "bool", "value": "true" },
