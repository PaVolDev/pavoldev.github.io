...
var sampleParams = [ //Список всех параметров, относящиеся только к оружию в руках
	...
	{ "fieldPath": "weapon.reloadScaleTime", "comment": "Множитель для скорости перезарядки [0.5 - 2]<br>Скорость анимации и время для перезарядки", "type": "float", "value": 0 },
